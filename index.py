...
app.layout = html.Div(children=[
                dbc.Row([
                    dbc.Col([
                        dbc.Card([
                            html.H2('GG', style={'font-family': 'Voltaire', 'font-size': '50px'}),
                            html.Hr(),
...
def render_graphs(cities, main_variable):
    ...
    #fig_product_income.update_layout(margin=dict(l=0, r=0, t=20, b=20), height=500, template='plotly_dark') - Plotly dark deixa o grafico escuro
